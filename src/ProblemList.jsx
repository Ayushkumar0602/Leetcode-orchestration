...
export default function ProblemList() {
    ...
    // --- Data fetching ---
    useEffect(() => {
        fetch('https://leetcode-orchestration-api.onrender.com/api/metadata')
            .then(r => r.json())
            .then(data => {
    ...
    useEffect(() => {
        ...
        fetch(`https://leetcode-orchestration-api.onrender.com/api/stats/user/${currentUser.uid}`)
            .then(r => r.json())
    ...
    useEffect(() => {
        ...
        fetch(`https://leetcode-orchestration-api.onrender.com/api/lists/${currentUser.uid}`)
            .then(r => r.json())
    ...
    useEffect(() => {
        const t = setTimeout(() => {
            ...
            fetch(`https://leetcode-orchestration-api.onrender.com/api/problems?${params}`)
                .then(r => r.json())
    ...
    const createList = async () => {
        ...
        try {
            const res = await fetch('https://leetcode-orchestration-api.onrender.com/api/lists', {
                method: 'POST',
