                ...
                <div style={{ textAlign: 'center', marginBottom: '1rem', position: 'relative' }}>
                    ...
                    <div style={{ position: 'relative', zIndex: 1 }}>
                        ...
                        <h1 className="hero-title">
                            <span style={{ color: '#fff' }}>Palantir</span>
                            ...
                            {loading ? <div style={{ padding: '5rem', textAlign: 'center' }}>Loading Palantir questions…</div> : problems.map((p, idx) => (
                                <div key={p.id} onClick={() => handleSolve(p)} className="problems-grid" style={{ borderBottom: idx < problems.length - 1 ? '1px solid rgba(255,255,255,0.05)' : 'none', cursor: 'pointer' }}>
                                    ...
                                    <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
                                        <button style={{ background: '#333', color: '#fff', border: 'none', borderRadius: '8px', padding: '6px 12px', cursor: 'pointer', fontSize: '0.85rem', fontWeight: 600 }}>Solve</button>
                                    </div>
                                </div>
                            ))}
                        </div>
