                ...
                <div style={{ textAlign: 'center', marginBottom: '1rem', position: 'relative' }}>
                    ...
                    <div style={{ position: 'relative', zIndex: 1 }}>
                        <div style={{ 
                            ...
                            background: 'rgba(255, 251, 0, 0.1)', border: '1px solid rgba(255, 251, 0, 0.4)',
                            ...
                            {loading ? <div style={{ padding: '5rem', textAlign: 'center' }}>Loading Snapchat questions…</div> : problems.map((p, idx) => (
                                <div key={p.id} onClick={() => handleSolve(p)} className="problems-grid" style={{ borderBottom: idx < problems.length - 1 ? '1px solid rgba(255,255,255,0.05)' : 'none', cursor: 'pointer' }}>
                                    ...
                                    <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
                                        <button style={{ background: '#FFFC00', color: '#000', border: 'none', borderRadius: '8px', padding: '6px 12px', cursor: 'pointer', fontSize: '0.85rem', fontWeight: 700 }}>Solve</button>
                                    </div>
                                </div>
                            ))}
                        </div>
