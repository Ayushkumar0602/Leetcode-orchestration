        ...
        <div style={{ minHeight: '100vh', background: '#080b14', color: 'var(--txt)', fontFamily: "'Inter', sans-serif" }}>
            ...
            <nav style={{ position: 'sticky', top: 0, zIndex: 100, background: 'rgba(8,11,20,0.85)', backdropFilter: 'blur(16px)', borderBottom: '1px solid rgba(255,255,255,0.07)', padding: '0 2rem', height: '60px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    {currentUser ? (
                        ...
                        <button
                            onClick={() => navigate('/login?redirect=/systemdesign/lld')}
                            style={{ background: '#a855f7', border: 'none', color: '#fff', padding: '6px 16px', borderRadius: '8px', fontSize: '0.85rem', fontWeight: 600, cursor: 'pointer' }}
                        >
                            Sign In
                        </button>
                    )}
            ...
            <div style={{ maxWidth: '900px', margin: '0 auto', padding: '3rem 2rem 6rem' }}>
                ...
                <div style={{ marginBottom: '3rem' }}>
                    ...
                    <h1 style={{ fontSize: '2.5rem', fontWeight: 800, color: 'var(--txt)', marginBottom: '1rem', letterSpacing: '-0.5px' }}>Low-Level Design Syllabus</h1>
